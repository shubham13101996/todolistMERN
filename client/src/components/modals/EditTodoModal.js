        ...
        <div className="flex flex-col mt-7">
          ...
          <div className="flex gap-1">
            <div
              ...
              className="cursor-pointer border-2 border-black w-[20px] h-[20px] bg-red-500"
            ></div>
            <div
            ...
            <div
              ...
              className="cursor-pointer border-2 border-black w-[20px] h-[20px] bg-pink-500"
            ></div>
            <div
              onClick={() => setColor("gray")}
              className="cursor-pointer border-2 border-black w-[20px] h-[20px] bg-gray-500"
            ></div>
          </div>
        </div>
